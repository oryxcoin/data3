...
uint256 hashGenesisBlock("0x8b613c596431e1fa274fa4f40b57a6ed344aeb529e9033256be29e09e00ea696");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 20); // Oryxcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Oryxcoin: 3.5 days
static const int64 nTargetSpacing = 0.5 * 60; // Oryxcoin: 2.5 minutes
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Oryx coin is here to stay with all organic coins";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x44b211703ea1003e70fc4b151dda14b0e5eb5a30c2a03f9151a7a7f841aa91fa"));
